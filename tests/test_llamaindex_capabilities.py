...
class TestLlamaIndexCapabilities:
    def __init__(self):
    ...
    def test_code_generation(self):
        """Test code generation capabilities with different LlamaIndex models."""
        # Initialize different model providers
        azure_api = LlamaIndexAPI(model_provider="azure-openai")
        openai_api = LlamaIndexAPI(model_provider="openai")
        mistral_api = LlamaIndexAPI(model_provider="mistral")
    ...
    def test_math_reasoning(self):
        """Test mathematical reasoning capabilities with different LlamaIndex models."""
        azure_api = LlamaIndexAPI(model_provider="azure-openai")
        openai_api = LlamaIndexAPI(model_provider="openai")
        mistral_api = LlamaIndexAPI(model_provider="mistral")
    ...
    def test_technical_writing(self):
        """Test technical documentation writing capabilities with different LlamaIndex models."""
        azure_api = LlamaIndexAPI(model_provider="azure-openai")
        openai_api = LlamaIndexAPI(model_provider="openai")
        mistral_api = LlamaIndexAPI(model_provider="mistral")
...
if __name__ == "__main__":
    ...
    test = TestLlamaIndexCapabilities()

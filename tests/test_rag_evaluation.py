...
from dllmforge.rag_evaluation import (RAGEvaluator, evaluate_rag_response, RAGEvaluationResult, EvaluationResult)
...
class TestRAGEvaluator:
    ...
    def test_save_evaluation_results(self, mock_langchain):
        ...
        faithfulness = EvaluationResult(metric_name="faithfulness",
                                        score=0.85,
                                        explanation="Good faithfulness",
                                        details={"test": "data"})

        answer_relevancy = EvaluationResult(metric_name="answer_relevancy",
                                            score=0.75,
...
class TestConvenienceFunctions:
    ...
    def test_evaluate_rag_response(self, mock_evaluator_class):
        ...
        result = evaluate_rag_response(question="What is the capital of France?",
...
class TestIntegration:
    ...
    def test_dataclass_serialization(self):
        ...
        eval_result = EvaluationResult(metric_name="test",
                                       score=0.8,

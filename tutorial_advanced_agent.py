...
print("• NODES: agent, calculation_node, info_node, unified_node, summary")
...
print("• CONDITIONAL EDGE: agent decides which tool node to use")
print("• REGULAR EDGES: tool nodes → summary → end")
print("=" * 50)
...
if __name__ == "__main__":
    ...
    print("• Conditional edges let AI choose the right water analysis path")
    print("=" * 50)
